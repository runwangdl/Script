...
def trim_onnx_model(model_path, output_node_name, save_path="network.onnx"):
...
def main(output_node_name, model_path="/app/Deeploy/DeeployTest/Tests/CCT/network_complete.onnx", input_path="/app/Deeploy/DeeployTest/Tests/CCT/inputs.npz", save_path="trimmed_network.onnx"):
    trimmed_model = trim_onnx_model(model_path, output_node_name, save_path)
    save_path = "/app/Deeploy/DeeployTest/Tests/CCT/network.onnx"
    onnx.save(trimmed_model, save_path)
    print(f"Saved: {save_path}")
