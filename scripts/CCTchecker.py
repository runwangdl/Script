...
def main(output_node_name, model_path="/app/Deeploy/DeeployTest/Tests/CCT/network.onnx", input_path="/app/Deeploy/DeeployTest/Tests/CCT/inputs.npz", save_path="trimmed_network.onnx"):
