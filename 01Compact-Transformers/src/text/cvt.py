...
class TextCVT(nn.Module):
    ...
    def __init__(self, seq_len = 64, word_embedding_dim = 300, embedding_dim = 768, patch_size = 2, *args, **kwargs):
...
def _text_cvt(num_layers, num_heads, mlp_ratio, embedding_dim, patch_size = 4, *args, **kwargs):
...
def text_cvt_2(*args, **kwargs):
    return _text_cvt(num_layers = 2, num_heads = 2, mlp_ratio = 1, embedding_dim = 128, *args, **kwargs)


def text_cvt_4(*args, **kwargs):
    return _text_cvt(num_layers = 4, num_heads = 2, mlp_ratio = 1, embedding_dim = 128, *args, **kwargs)


def text_cvt_6(*args, **kwargs):
    return _text_cvt(num_layers = 6, num_heads = 4, mlp_ratio = 2, embedding_dim = 128, *args, **kwargs)
