...
__all__ = ['text_cct_2', 'text_cct_4', 'text_cct_6']
...
def text_cct_2(*args, **kwargs):
    return _text_cct(num_layers = 2, num_heads = 2, mlp_ratio = 1, embedding_dim = 128, *args, **kwargs)


def text_cct_4(*args, **kwargs):
    return _text_cct(num_layers = 4, num_heads = 2, mlp_ratio = 1, embedding_dim = 128, *args, **kwargs)


def text_cct_6(*args, **kwargs):
    return _text_cct(num_layers = 6, num_heads = 4, mlp_ratio = 2, embedding_dim = 256, *args, **kwargs)
