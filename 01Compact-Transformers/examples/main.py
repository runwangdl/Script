...
def init_parser():
    ...
    parser.add_argument('-m', '--model', type = str.lower, choices = model_names, default = 'cct_2', dest = 'model')
    ...
    parser.add_argument('--conv-layers', default = 2, type = int, help = 'number of convolutional layers (cct only)')

    parser.add_argument('--conv-size', default = 3, type = int, help = 'convolution kernel size (cct only)')
...
def main():
    ...
    train_dataset = datasets.__dict__[args.dataset.upper()](root = args.data,
                                                            train = True,
                                                            download = True,
                                                            transform = augmentations)

    val_dataset = datasets.__dict__[args.dataset.upper()](root = args.data,
                                                          train = False,
                                                          download = False,
